...
from src.stats import get_most_listened_artist_table, get_most_listened_songs_table

from configurations.streamlit_config import *
import os
...
if uploaded_files:
    ...
    df_artists = get_most_listened_artist_table(df)
    ...
    df_songs = get_most_listened_songs_table(df)
